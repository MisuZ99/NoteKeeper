...
import com.trainingcourse.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;
import com.trainingcourse.notekeeper.NoteKeeperDatabaseContract.NoteInfoEntry;
import com.trainingcourse.notekeeper.NoteKeeperProviderContract.Courses;
import com.trainingcourse.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        else if(uri.getLastPathSegment().equals("courses")) {
            uriMatch=COURSES;
        }
        else if(uri.getPathSegments().contains("notes")&&!uri.getLastPathSegment().equals("notes")){
            uriMatch=NOTES_ROW;
        }
        else if(uri.getPathSegments().contains("courses")&&!uri.getPathSegments().equals("courses")){
            uriMatch=COURSES_ROW;
        }
        else {
            uriMatch=NOTES_EXPANDED;
        }
        switch(uriMatch) {
            case COURSES:
